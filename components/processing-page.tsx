...
export function ProcessingPage({ jobId }: { jobId: string }) {
  ...
  async function retryCurrentJob() {
    if (!activeJobId) { window.location.reload(); return; }
    setRetrying(true);
